...
async function generateParagraphTTS(spaceId,documentId,paragraphId,command){
    return await this.sendRequest(`/spaces/audio/${spaceId}/${documentId}/${paragraphId}`, "POST", command);
}
